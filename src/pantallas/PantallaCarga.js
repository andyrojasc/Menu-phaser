...
PantallaCarga.prototype = { //Cargar toda la pantalla
    ...
    loadImages: function() {
        ...
        game.load.image('botonJugar', 'assets/img/menuPrincipal/botonJugarMenuPrincipal.png');
        game.load.image('botonSalir', 'assets/img/menuPrincipal/botonSalirMenuPrincipal.png');
        game.load.image('botonConfiguracion', 'assets/img/menuPrincipal/configMenuPrincipal.png');
